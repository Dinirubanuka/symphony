    ...
    public function orders()
    {
        ...
        foreach ($completeOrders as $order) {
            ...
            foreach ($orderSuborderIDs as $suborderID) {
                ...
                $sp_data = $this->userModel->getServiceProviderData($suborderDetails['serviceprovider_id']);
                $suborderDetails['sp_name'] = $sp_data->business_name;
                $suborderDetails['sp_contact'] = $sp_data->business_contact_no;
