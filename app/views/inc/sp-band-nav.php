...
">Musicians</a>
                    ...
                    <li><a class="nav-link" href="<?php echo URLROOT; ?>/serviceproviders/band">Inventory</a></li>                    
                    <li><a class="nav-link" href="<?php echo URLROOT; ?>/serviceproviders/addband">Add Band</a></li>
