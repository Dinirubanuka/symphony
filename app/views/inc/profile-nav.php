            ...
            <div id="dropdown1" class="dropdown">
              <ul role="menu">
                ...
                <li role="menuitem">
                  ...
                  <img width="48" height="48" src="https://img.icons8.com/nolan/64/filled-star.png" alt="filled-star"/>
                    <div>
                          <span class="dropdown-link-title">Featured</span>
              ...
              <ul role="menu">
                ...
                <li role="menuitem">
                  ...
                  <img width="40" height="40" src="https://img.icons8.com/ios/50/guitarist.png" alt="guitarist"/>Solo Musicians</a>
                </li>
              </ul>
            </div>
          </li>
          <li>
            ...
            <div id="dropdown2" class="dropdown">
              <ul role="menu">
                ...
                <li role="menuitem">
                  <a class="dropdown-link" href="#illustrations">Hiring</a>
                </li>
              </ul>
              <ul role="menu">
                <li>
                ...
                <li role="menuitem">
                  <a class="dropdown-link" href="#mac-windows">New in our Platform</a>
                </li>
                <li role="menuitem">
