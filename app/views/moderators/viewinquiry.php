...
function approveInquiry(inquiryId) {
    ...
    window.location.href = "<?php echo URLROOT; ?>/moderators/approveInquiry/"+inquiryId;
}

function completeInquiry(inquiryId) {
    console.log('Button clicked for inquiry ID:', inquiryId);
    window.location.href = "<?php echo URLROOT; ?>/moderators/completeInquiry/"+inquiryId;
}
</script>
...
function addNewMessage(messageText, isOutgoing) {
    ...
    window.location.href = "<?php echo URLROOT; ?>/moderators/sendMessageUser/"+modifiedmessage+"/"+<?php echo $data['inquiry']->inquiry_id ?>+"/"+<?php echo $data['user']->id ?>+"/"+modifieddate;   
}
</script>
</body>
</html>
