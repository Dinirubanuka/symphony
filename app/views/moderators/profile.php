...
<header id="nav-menu" aria-label="navigation bar">
  <div class="container">
    <div class="nav-start">
      <a class="logo" href="<?php echo URLROOT; ?>/moderators">
        <img
                src="<?php echo logo; ?>"
                width="35"
                height="35"
...
<!--          />-->
<!--        </a>-->
        <a class="btn btn-primary" href="<?php echo URLROOT; ?>/moderators/index">Back</a>
...
<div class = "bigClass">
    <div class="input-box">
      <label>Full Name: <?php echo $data['moderator_name']; ?></label>
    </div>

    <div class="input-box">
      <label>Email Address: <?php echo $data['moderator_email']; ?></label>
    </div>

    <div class="column">
      <div class="input-box">
        <label>Phone Number: <?php echo $data['moderator_contact_no']; ?></label>
      </div>
      <div class="input-box">
        <label>NIC Number: <?php echo $data['moderator_nic']; ?></label>
      </div>
      <div class="input-box">
        <label>Address: <?php echo $data['moderator_address']; ?></label>
      <div class="input-box">
        <label>Type: <?php echo $data['type']; ?></label>
      </div>
      <!-- </div>
      <div class="llink">
