    ...
    <div class="right-component">
      ...
      <script>
          function acceptProfile(sp_id) {
            window.location.href = "<?php echo URLROOT; ?>/moderators/acceptServiceProvider/"+sp_id;
        }

        function rejectProfile(sp_id) {
            window.location.href = "<?php echo URLROOT; ?>/moderators/rejectServiceProvider/"+sp_id;
        }
