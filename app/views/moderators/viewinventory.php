...
<<body>
  <div class="container_body">
    ...
    <div class="right-component">
      <h2>View Service Provider Inventory Moderator ID #<?php echo $data['admin_data']->moderator_id; ?> | Service Provider #<?php echo $data['sp']->serviceprovider_id; ?></h2>
    ...
    function viewProduct(item) {
        ...
        window.location.href = "<?php echo URLROOT; ?>/moderators/viewProduct/Equipment/" + product_id;
    }
    function viewStudio(item) {
        var product_id = item.getAttribute("product_id");
        window.location.href = "<?php echo URLROOT; ?>/moderators/viewProduct/Studio/" + product_id;
    }
    function viewBand(item) {
        var product_id = item.getAttribute("product_id");
        window.location.href = "<?php echo URLROOT; ?>/moderators/viewProduct/Band/" + product_id;
    }
    function viewSinger(item) {
        var product_id = item.getAttribute("product_id");
        window.location.href = "<?php echo URLROOT; ?>/moderators/viewProduct/Singer/" + product_id;
    }
    function viewMusician(item) {
        var product_id = item.getAttribute("product_id");
        window.location.href = "<?php echo URLROOT; ?>/moderators/viewProduct/Musician/" + product_id;
    }
    </script>
    </div>
  </div>
