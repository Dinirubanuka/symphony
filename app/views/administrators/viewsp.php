      ...
      <div class="profile-container">
        <div class="profile-header">
          ...
          <div class="buttons">
            ...
            <button id="inventoryBtn" onclick="viewSPInvetory(<?php echo $data['request']->serviceprovider_id ?>)">View Inventory</button>
          </div>
        </div>
      ...
      <script>
        ...
        function banSP(serviceproviderID) {
          ...
          if (rejectionReason !== null && rejectionReason !== "") {
              ...
              if (confirm("Are you sure you want to ban this Service Provider?")) {
                  ...
                  window.location.href = "<?php echo URLROOT; ?>/administrators/banserviceprovider/" + serviceproviderID + "/" + encodedReason;
              }
            } else {
        ...
        function unbanSP(serviceproviderID) {
          ...
          if (confirm("Are you sure you want to unban this Service Provider?")) {
              // Execute PHP code to delete the moderator
              window.location.href = "<?php echo URLROOT; ?>/administrators/unbanserviceprovider/" + serviceproviderID;
          }
        }

        function viewSPOrders(serviceproviderID) {
          window.location.href = "<?php echo URLROOT; ?>/administrators/viewSPOrders/" + serviceproviderID;
        }

        function viewSPInvetory(serviceproviderID){
            window.location.href = "<?php echo URLROOT; ?>/administrators/viewSPInvetory/" + serviceproviderID;
        }
      </script>
    </div>
  </div>
