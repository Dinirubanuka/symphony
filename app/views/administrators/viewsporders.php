...
<script>
    function viewOrder(OrderID) {
        window.location.href = "<?php echo URLROOT; ?>/administrators/viewSubOrder/" + OrderID;
    }
    ...
    function viewItem(item) {
        ...
        window.location.href = "<?php echo URLROOT; ?>/administrators/viewProduct/" + product_type + "/" + product_id;
    }
</script>
</body>
