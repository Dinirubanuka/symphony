  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      height: 100vh;
      /* display: grid; */
      background-image: url(https://img.freepik.com/free-photo/colorful-abstract-nebula-space-background_53876-111357.jpg?w=1060&t=st=1695630332~exp=1695630932~hmac=ab4ddec8f95cbe81e27bc9792db64cf1c6f47099cd6226dd1540b7c7b2283f34);
    ...
    <div class="nav-start">
      ...
      <nav class="menu">
        <ul class="menu-bar">
          ...
          <li><a class="nav-link" href="<?php echo URLROOT; ?>/administrators/addmoderator">Add Moderator</a></li>
