  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      height: 100vh;
      /* display: grid; */
      background-image: url("<?php echo adbg; ?>");
    ...
    <div class="nav-start">
      ...
      <nav class="menu">
        <ul class="menu-bar">
            ...
            <div id="dropdown1" class="dropdown">
              <ul role="menu">
                ...
                <li role="menuitem">
                  <a class="dropdown-link" href="#subscriptions">
                    <div>
                      <span class="dropdown-link-title">View Moderators</span>
                    </div>
                  </a>
                </li>
                <li role="menuitem">
                  <a class="dropdown-link" href="<?php echo URLROOT; ?>/administrators/addmoderator">
                    <div>
                      <span class="dropdown-link-title">Add Moderators</span>
                    </div>
                  </a>
                </li>
              </ul>
              ...
              <ul role="menu">
                <li class="dropdown-title">
                  <span class="dropdown-link-title">Inquiries</span>
                </li>
                <li role="menuitem">
          ...
          <li><a class="nav-link" href="/">Backup and Restore</a></li>
          <li><a class="nav-link" href="/">Standings</a></li>
...
<!--          />-->
<!--        </a>-->
        <a class="btn btn-primary" href="<?php echo URLROOT; ?>/administrators/index">Back</a>
        <a class="btn btn-primary" href="<?php echo URLROOT; ?>/administrators/logout">Log out</a>
...
<div class = "bigClass">
    <div class="input-box">
      <label>Full Name: <?php echo $data['admin_name']; ?></label>
    </div>

    <div class="input-box">
      <label>Email Address: <?php echo $data['admin_email']; ?></label>
    </div>

    <div class="column">
      <div class="input-box">
        <label>Phone Number: <?php echo $data['admin_contact_no']; ?></label>
      </div>
      <div class="input-box">
        <label>NIC Number: <?php echo $data['admin_nic']; ?></label>
      </div>
      <div class="input-box">
        <label>Address: <?php echo $data['admin_address']; ?></label>
      <!-- </div>
      <div class="llink">
