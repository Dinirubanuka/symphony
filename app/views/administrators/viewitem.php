...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/admin-viewItem.css"
    ">
...
<div class="upperHome">
    <a href="<?php echo URLROOT?>/administrators/viewSPOrders/<?php echo ($data['created_by'])?>"><img src="http://localhost/symphony/img/home.png" alt="camera-icon" class="" id="" style="height: 30px;width: 30px;"></a>
</div>
