...
<div class='split-pane col-xs-12 col-sm-6 uiux-side'>
  <div>
    ...
    <button onclick="window.location.href='<?php echo URLROOT; ?>/serviceproviders/serviceproviderlogin';">
...
<div class='split-pane col-xs-12 col-sm-6 frontend-side'>
  <div>
    ...
    <button onclick="window.location.href='<?php echo URLROOT; ?>/users/login';">
