...
<div class="biggerBody">
        ...
        <div class="upperLeft">
            <div class="photo-outer">
                <div class="photo-inner">
                    ...
                    <img src="http://localhost/symphony/img/pen2.png" alt="camera-icon" class="photo" id="photo-1" onclick="myfunc()"/>
                </div>
            </div>
            <div class="singerNameLoc">
                <div class="singerName">
                    <h1>Name</h1>
                    <img src="http://localhost/symphony/img/pen2.png" alt="camera-icon" class="" id="" style="height: 35px;width: 35px;z-index: 2;"
                         onclick="myfunc()"/>
                </div>
                <div class="location">
    ...
    <div class="titleHours">
        <div class="edit title">
            <h2><input type="text" value="Nick name"></input></h2>
        </div>
        <div class="edit mail">
            <h2><input type="text" value="email"></h2>
        </div>
        <div class="edit number">
            <h2><input type="text" value="number"></h2>
        </div>
        <div class="edit rate">
            <h2><input type="text" value="rate"></h2>
        </div>
    </div>
    <!--middle part-->
        ...
        <div class="video-upload">
            ...
            <div class="video-section">
                <div class="video-link">
                    <h2><input type="text" value="link"></input></h2>
                </div>
                <div class="select-options">
                    <!--            location-->
                    <div class="title locations" style="padding: 10px">
                        <div class="dropdown2">
                    ...
                    <!--            instrument-->
                    <div class="title instrument" style="padding: 10px">
                        <div class="dropdown2">
...
<div class="modal" id="options-modal">
    <div class="modal-content">
        ...
        <form action="<?php echo URLROOT; ?>/serviceproviders/profilePhotoUpdate" method="post"
              enctype="multipart/form-data">
            <input type="file" id="photo" accept=".jpg, .jpeg, .png, .HEIC" name="photo"
                   class="<?php echo (!empty($data['image_err'])) ? 'is-invalid' : ''; ?>"
