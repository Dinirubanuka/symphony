...
<div class="main-grid-reports">
    ...
    <div class="user-info-box">
        <div class="user-avatar">
            ...
            <img src="<?php echo URLROOT; ?>/img/mag_img/<?php echo $data['sp']->profile_photo; ?>" alt="User Avatar">
        </div>
        <div class="user-details">
            <h2><?php echo $data['sp']->business_name; ?></h2><br>
            <ul>
                <li><strong>Lifetime Earnings(LKR):</strong> <?php echo  $data['lifetimeEarnings'] ?>.00 </li><br>
                <li><strong>Lifetime Orders:</strong> <?php echo $data['lifetimeOrders'] ?></li><br>
                <li><strong>Total Instruments Registered:</strong> <?php echo $data['instrumentCount'] ?></li><br>
                <li><strong>Total Studios Registered:</strong> <?php echo $data['studioCount'] ?></li><br>
                <li><strong>Total Singers Registered:</strong> <?php echo $data['singerCount'] ?></li><br>
                <li><strong>Total Bands Registered:</strong> <?php echo $data['bandCount'] ?></li><br>
                <li><strong>Total Musicians Registered:</strong> <?php echo $data['musicianCount'] ?></li><br>
            </ul>
            <br><h1>Report Generation</h1>
            <form id="reportForm" action="<?php echo URLROOT; ?>/serviceproviders/generateReports" method="post" enctype="multipart/form-data">
