...
<body>
<!-----------profile-nav-bar-------->
<?php require_once APPROOT . '/views/inc/sp-band-nav.php'; ?>
<!--------body-------->
<div class="outer">
    <form action="<?php echo URLROOT; ?>/Serviceproviders/updateBand/<?php echo $data->product_id ?>" method="post" enctype="multipart/form-data">
        <div class="biggerBody">
                ...
                <div class="upperLeft">
                    <div class="photo-outer">
                        <div class="photo-inner">
                            <!--                        <div class="photo-inner">-->
                            <img src="http://localhost/symphony/img/serviceProvider/<?php echo $data->bandPhoto ?>"
                                 id="previewPhoto_4"
                    ...
                    <div class="singerNameLoc">
                        <div class="singerName">
                            <h1><input name="bandName" value="<?php echo $data->Title; ?>"></h1>
                        </div>
                        <div class="location">
            ...
            <div class="titleHours">
                <div class="edit title">
                    ...
                    <h2><input type="text" name="leaderName" value="<?php echo $data->leaderName; ?>"></h2>
                </div>
                <div class="edit memCount">
                    <label>Member Count</label>
                    <h2><input type="text" name="memCount" value="<?php echo $data->memberCount; ?>"></h2>
                </div>
                <div class="edit mail">
                    <label>Email</label>
                ...
                <div class="middle">
                    <div class="decription">
                        <p class="descriptionContent" id="descriptionContent">
                            <span>Write a Description</span><br>
