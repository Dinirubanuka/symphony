...
/* Style the container of the "Create Event Package" page */
body {
  text-align: center;
...
#event-package-form input[type="text"],
#event-package-form select {
  width: 100%;
  padding: 10px;
  margin-bottom: 10px;
  border: 1px solid #ddd;
...
/* Style the "Create Package" button */
#event-package-form button[type="submit"] {
  background-color: #3498db;
  color: #fff;
  padding: 10px 20px;
  border: none;
...
/* Hover effect for the "Create Package" button */
#event-package-form button[type="submit"]:hover {
  background-color: #2980b9;
}
    ...
    <div class="nav-start">
      ...
      <nav class="menu">
        <ul class="menu-bar">
          ...
          <li><a class="nav-link" href="/">Function 05</a></li>
...
<body>
  <h1>Create Event Package</h1>
  <form id="event-package-form">
      <label for="package-name">Package Name:</label>
      <input type="text" id="package-name" name="package-name" required>
      
      <label for="items">Select Items for Package:</label>
